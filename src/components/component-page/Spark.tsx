...
import clickSparkCode from '../../../registry/new-york/ClickSpark/ClickSpark.tsx?raw'
...
>
  ...
  return (
    <ComponentPageLayout
      title="Spark"
      code={code}
      cliCode="npx shadcn@latest add https://klick-here.vercel.app/r/click-spark.json"
